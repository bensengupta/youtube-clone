...
>(({ className, ...props }, ref) => (
  <ModalPortal>
    ...
    <AlertPrimitive.Content
      ref={ref}
      className={cn(
        `bg-modal-background fixed
         left-[50%] top-[50%]
         z-50 grid w-[calc(100%-2rem)]
         max-w-4xl translate-x-[-50%] translate-y-[-50%] rounded-lg
         border
         shadow-lg
         duration-200
...
const ModalPrimaryHeader = ({
  ...
  <div
    className={cn("flex items-center gap-4 py-2.5 pl-6 pr-2.5", className)}
    {...props}
  />
);
...
const ModalHeader = ({
  ...
  <div
    className={cn("flex flex-col border-b-[1px] border-divider", className)}
    {...props}
  />
);
...
const ModalFooter = ({
  ...
  <div
    className={cn(
      "flex items-center justify-end gap-4 space-x-2 border-t-[1px] border-divider py-2.5 pl-6 pr-2.5",
      className
    )}
    {...props}
  />
